...
namespace MinimalSocket
{
    ...
    public:
        ...
        void mustBeFreePort()
        {
            must_be_free_port = true;
        };
        bool shallBeFreePort() const
        {
            return must_be_free_port;
        }

    protected:
        PortToBindAware(Port port)
            : port_to_bind(port) {};
    ...
    public:
         ...
         * socket.
         */
        AddressFamily getRemoteAddressFamily() const
        {
            return remote_address_family;
        }
