...
namespace MinimalSocket::udp
{
    ...
    protected:
        ...
        UdpBlocking(Args&&... args)
            : UdpBase{std::forward<Args>(args)...}
        {}
    };
    ...
    protected:
        template <typename... Args>
        Udp_(Args&&... args)
            : UdpBlocking{std::forward<Args>(args)...}
        {}
    };
    ...
    protected:
        template <typename... Args>
        Udp_(Args&&... args)
            : UdpNonBlocking{std::forward<Args>(args)...}
        {}
    };
    ...
    public:
        ...
        Udp(Udp<BlockMode>&& o)
            : Udp_<BlockMode>{std::forward<Udp_<BlockMode>>(o)}
        {}
